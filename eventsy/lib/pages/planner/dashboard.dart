import 'package:eventsy/pages/planner/message/message.dart';
import 'package:eventsy/pages/planner/profile/profile.dart';
import 'package:eventsy/pages/planner/projects/booking.dart';
import 'package:eventsy/pages/planner/search/search.dart';
...
class PlannerDashboard extends StatefulWidget {
  ...
  @override
  State<PlannerDashboard> createState() => _PlannerDashboard();
}

class _PlannerDashboard extends State<PlannerDashboard> {
