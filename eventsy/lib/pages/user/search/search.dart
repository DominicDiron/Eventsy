...
import 'package:eventsy/pages/user/search/viewProfile.dart';
...
class _SearchState extends State<Search> {
  ...
  Future<bool> addFavourite(int plannerId) async {
    ...
    final response = await http.post(Uri.parse("${url}userFavouritePlanner/$currentuserId/$plannerId"));

    print("${url}userFavouritePlanner/$currentuserId/$plannerId");
